                ...
                foreach ($values as $value) {
                    ...
                    echo        '</select>
                            ...
                            <td>
                                ...
                                <div class="column-item">
                                    <input type="radio" id="radioLeft'.$value['application_id'].'" name="limbs'.$value['application_id'].'" value="3" '; if ($value['limbs'] == '3') echo 'checked'; echo '>
                                    <label for="radioLeft'.$value['application_id'].'">3</label>
                                </div>
                                <div class="column-item">
